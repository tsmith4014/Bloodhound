#what was deployed live on aws lambda for DevOps Bravo Platoon Cohort
import boto3
import os
...
def format_message(resources):
    message = ":dog2: Woof! Woof! :dog2:\n Heads-up Bravo Platoon Bloodhound found the following resources in use: \n"
...
def send_slack_message(message):
    try:
        # Read the Slack bot token and channel ID from environment variables
